...
> :information_source: For this banner, I pulled across various days.
...
#### Mar. 10th, 2022
* Spring Sonya's sparking wasn't recorded since I didn't have [Feh Pass] while first pulling, and a friend helped me out here. So, she doesn't show up in the video.

#### Mar. 18th, 2022

| Unit | IVs | Type at time | Note(s) |
| :- | :- | :- | :- |
| Spring Maria | +spd/-HP | Focus | Fodder TBA |
...
| Galzus | +att/-res | Pitybreaker | Fodder TBA |
...
| Unit | IVs | Type at time | Note(s) |
| :- | :- | :- | :- |
| Brave Lyn | +HP/-att | Pseudo-demote | Already foddered long ago |
| Forsyth | +att/-HP | Pitybreaker | Fodder TBA |
| :green_circle: Ascended Ishtar | +att/-spd | Focus | Base copy |
