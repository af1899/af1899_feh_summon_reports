...
Rather than making 5 time-consuming videos for each, I've made a test edit, in which **I summarized my pulls on all 5 sessions**, the detailed reports are as follows.

# Video

>  [:film_strip: Here](https://youtu.be/v7At9vn4780)

# Statistics

## `1`: [Legendary Heroes - Ninian]
> :information_source: Banner details: [*see wiki*](https://feheroes.fandom.com/wiki/Legendary_Heroes_-_Ninian).
...
| :green_circle: Tine | +att/-def | Focus | Has been used as base for merge. |
...
## `2`: [Special: Rearmed Robin &amp; More]
> :information_source: Banner details: [*see wiki*](https://feheroes.fandom.com/wiki/Special_Rearmed_Robin_%26_More).
...
| Unit | IVs | Type at time | Note(s) |
| :- | :- | :- | :- |
| :green_circle: Rearmed Female Robin | +HP/-spd | Focus | Fodder chance used to give Idoun the following: [Arcane Grima] and [A/S Near Save 3]. |
...
| :green_circle: Ascended Eir | +HP/-res | Focus | ~~In this house we don't know what's foddering Eir.~~ |
| :green_circle: Rearmed Female Robin | +att/-def | Focus | Fodder chance used to give Ascended Idoun the following after foddering a Legendary Fae to Robin: [Arcane Grima], [Distant Stance] and [Def/Res Menace]. Robin was merged to +1 +att at this time. |
| :green_circle: Ascended Eir | +att/-def | Focus | In the 39th pull, I got her with perfect IVs, I've decided to use this copy as base for merging, as +att is a super asset, +spd would be her secondary asset. |
| :green_circle: Ascended Eir | *Sparked* | Focus | This brought her to +2 merges. |

## Reasoning and commentary

Considering that that [Rearmed Heroes](https://feheroes.fandom.com/wiki/Category:Rearmed_Heroes) can be foddered without losing them (once per copy), I've decided to pull for Robin and Eir (my favorite OC in *FEH*), I adore Robin and this has proven to be a chance to collect some highly useful skills too, and an [Ascendant Floret] to decide the secondary boon of my Legendary Julia later on.
...
## `3`: [Revival: Ascended Idunn]
> :information_source: Banner details: [*see wiki*](https://feheroes.fandom.com/wiki/New_Heroes_%26_Ascended_Idunn).
...
| Unit | IVs | Type at time | Note(s) |
| :- | :- | :- | :- |
| :green_circle: Ascended Idoun | +spd/-def | Focus | Brought her to +3. |
...
| :green_circle: Ascended Idoun | *Sparked* | Focus | Brought her to +4. |
| :green_circle: Ascended Idoun | +spd/-HP | Focus | Brought her to +5. |
...
## `4`: [New Heroes Return: Ascendants]
> :information_source: Banner details: [*see wiki*](https://feheroes.fandom.com/wiki/New_Heroes_Return:_Ascendants).
...
Indeed, I.S. [didn't notify us of this banner coming up in the schedule](https://feheroes.fandom.com/wiki/New_Event_Calendar_Is_Here!_(Nov_2022)_(Notification))... this banner came as a shock to me, I was somewhat ready for it even though I didn't have much saved up, mainly due to spending about two weeks before this banner came up.

And let's say that unlike previous ones, this one was quite a pain, even with the base rate of it being 6% and increasing by .5% every 5 pulls.

But the worst offender is again, only getting Ascended Mareeta via the spark feature, it's unfortunate how this kept happening.
...
## `5`: [Book VII Begins: Seiðr and More]
> :information_source: Banner details: [*see wiki*](https://feheroes.fandom.com/wiki/Book_VII_Begins:_Sei%C3%B0r_and_More).
...
| :green_circle: Rearmed Ophelia | +HP/-res | Focus | Fodder chance used to give Sophia the following: [Arcane Eclipse], [Special Spiral 4] and [Atk/Res Finish 2]. Copy will be kept for [HM] grind when the cap raises. |
...
| :green_circle: Seiðr | *Sparked* | Focus | Another one I could only get via spark. |
